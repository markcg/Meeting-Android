...
public class FieldMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_field_maps);
        this.lat = getIntent().getDoubleExtra("lat", 18.796143);
        this.lng = getIntent().getDoubleExtra("lng", 98.979263);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(field).title("Field"));
